...
require("lazy").setup({
	...
	--Kickstart used to recommend vim-sleuth
	...
	},
	{
		...
		config = function()
			...
			vim.api.nvim_create_autocmd("LspAttach", {
				...
				callback = function(event)
					...
					-- Adding an extra mapping for this one (same as Lazy Vim)
        ...
        --as a dependency for luasnip.
			...
			if is_windows == false then
				-- Lemme explain: I don't do much coding on my Windows nvim
				-- What is above is my "minimum"
				servers.gopls = {}
		...
		opts = {
			...
			format_on_save = function(bufnr)
				...
				local disable_filetypes = {
					c = true,
					cpp = true,
					-- Had to add html because it's messing up my pre tags
					html = true,
				}
